...
<html lang = "vi">
	...
	<head>
		...
		<!-- Stylesheets -->
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/reset.css')); ?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/font-awesome.min.css')); ?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/weather-icons.min.css')); ?>" />
		<link href='http://fonts.googleapis.com/css?family=Noto+Sans:400,400italic,700,700italic' rel='stylesheet' type='text/css'>
		<link href='http://fonts.googleapis.com/css?family=Arvo:400,400italic,700,700italic' rel='stylesheet' type='text/css'>
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/bootstrap.min.css')); ?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/dat-menu.css')); ?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/main-stylesheet.css')); ?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/ot-lightbox.css')); ?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/shortcodes.css')); ?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/responsive.css')); ?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/mystyle.css')); ?>" />
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('home/css/demo-settings.css')); ?>" />
 ...
 -->
					...
					<div class="wrapper">
						...
						<nav class="top-menu-list">
							<ul class="load-responsive" rel="Top Menu">
								<li><a href="<?php echo e(url('')); ?>"><img src="<?php echo e(asset('home/'.$contact->logo)); ?>" alt="No logo" style="height: 25px"></a></li>
								<li>
				...
				<div class="wrapper">
					...
					<div class="header-main">
						...
						<div class="header-main-logo">
							<a href="<?php echo e(url('')); ?>"><img src="<?php echo e(asset('/logo_zing_trithuc.png')); ?>" alt="No logo" /></a>
						</div>
		...
		<!-- Scripts -->
		<script type="text/javascript" src="<?php echo e(asset('home/jscript/jquery-latest.min.js')); ?>"></script>
		<script type="text/javascript" src="<?php echo e(asset('home/jscript/bootstrap.min.js')); ?>"></script>
		<script type="text/javascript" src="<?php echo e(asset('home/jscript/modernizr.custom.50878.js')); ?>"></script>
		<script type="text/javascript" src="<?php echo e(asset('home/jscript/iscroll.js')); ?>"></script>
		<script type="text/javascript" src="<?php echo e(asset('home/jscript/dat-menu.js')); ?>"></script>
		<script type="text/javascript" src="<?php echo e(asset('home/jscript/theme-scripts.js')); ?>"></script>
		<script type="text/javascript" src="<?php echo e(asset('home/jscript/ot-lightbox.js')); ?>"></script>
		<script type="text/javascript" src="<?php echo e(asset('js/jquery.sticky-kit.min.js')); ?>"></script>
	<!-- END body -->
	<script>
		if ($(window).width() >700) {
