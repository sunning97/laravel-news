							...
							<div class="row">
								<div class="col-md-12">
									...
									<a href="<?php echo e($adverts_center[0]->link); ?>" target="_blank">
										<img src="<?php echo e(asset('img/images_bn/'.$adverts_center[0]->img)); ?>" alt="No image" width="100%" style="object-fit: contain;" />
									</a>
									<?php endif; ?>
								</div>
							</div>
		...
		<div class="content-panel">
			<div class="content-panel-body do-space">
				...
				<a href="<?php echo e($adverts_main[0]->link); ?>" target="_blank">
					<img src="<?php echo e(asset('img/images_bn/'.$adverts_main[0]->img)); ?>" alt="No image" width="100%" style="object-fit: contain; max-height: 150px; display: block;overflow:hidden; margin-bottom: 20px;" />
				</a>
				<?php endif; ?>
			</div>
		<!-- END .content-panel -->
