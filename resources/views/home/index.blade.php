					...
					<div class="row">
								...
								<div class="item" data-color-top-slider="#867eef">
									<div class="item-header">
										<a href="{{url('chi-tiet/'.$hot['slug'])}}">
											...
											<img src="{{asset('img/news/300x300/'.$hot['newimg'])}}" alt="No image" />
										</a>
									</div>
						...
						<div class="visible-xs col-xs-12">
							<div class="mobile_hot_img">
								<a href="{{url('/chi-tiet/'.$hot->slug)}}" title="{{$hot->newsname}}"><img class="img-responsive" src="{{asset('img/news/300x300/'.$hot['newimg'])}}" alt="{{$hot['newimg']}}"></a>
							</div>
						...
						<div class="visible-xs col-xs-6 padding4 mobile_item">
							<div class="mobile_img">
								<a href="{{url('/chi-tiet/'.$m_item->slug)}}" title="{{$m_item->newsname}}"><img class="img-responsive" src="{{asset('img/news/300x300/'.$m_item['newimg'])}}" alt=""></a>
							</div>
							<div class="mobile_title">
					...
					<div class="content-panel">
						...
						@else
							<a href="{{$adverts_main[$ads]->link}}" target="_blank">
								<img src="{{asset('img/images_bn/'.$adverts_main[$ads]->img)}}" alt="No image" width="100%" style="object-fit: contain; max-height: 150px; display: block;overflow:hidden; margin-bottom: 20px;" />
							</a>
						@endif
						</div>
					<?php $ads = $ads +1; ?>
