						...
						<div class="visible-xs col-xs-12">
							<div class="mobile_hot_img">
								<a href="{{url('/chi-tiet/'.$hot->slug)}}" title="{{$hot->newsname}}">
									<img class="img-responsive" src="{{ asset('img/news/300x300/'.$hot->newimg)}}" alt="{{$hot->newimg}}">
								</a>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<a href="{{$adverts_center[0]->link}}" target="_blank">
										<img src="{{ asset('img/images_bn/'.$adverts_center[0]->img)}}" alt="No image" width="100%" style="object-fit: contain;" />
									</a>
									@endif
								</div>
							</div>
		...
		<div class="content-panel">
			<div class="content-panel-body do-space">
				...
				<a href="{{$adverts_main[0]->link}}" target="_blank">
					<img src="{{ asset('img/images_bn/'.$adverts_main[0]->img)}}" alt="No image" width="100%" style="object-fit: contain; max-height: 150px; display: block;overflow:hidden; margin-bottom: 20px;" />
				</a>
				@endif
			</div>
		<!-- END .content-panel -->
