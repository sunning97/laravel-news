			...
			<div class="item">
				<div class="item-header">
					<a href="{{url('chi-tiet/'.$item_lt->slug)}}">
						<img src="{{ asset('img/news/100x100/'.$item_lt->newimg)}}" alt="no img" width="80" />
					</a>
				</div>
			...
			<div class="item">
				<div class="item-header">
					...
					<a href="{{$adverts_bottom[0]->link}}">
						<img src="{{ asset('img/images_bn/'.$adverts_bottom[0]->img)}}" alt="No image" />
					</a>
					@endif
				</div>
			</div>
		...
		<div class="item">
			<div class="item-header">
				<a href="{{url('chi-tiet/'.$item_most->slug)}}" title="{{$item_most->newsname}}">
					<b>{{$count}}</b>  <img src="{{ asset('img/news/100x100/'.$item_most->newimg)}}" alt="no img" width="80" />
				</a>
			</div>
			<div class="item-content">
		...
		<div class="item">
			<div class="item-header">
				...
				<a href="{{$adverts_bottom[1]->link}}">
					<img src="{{ asset('img/images_bn/'.$adverts_bottom[1]->img)}}" alt="No image" />
				</a>
				@endif
			</div>
		</div>
